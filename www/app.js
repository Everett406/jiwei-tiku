...
function openImportSheet() {
  ...
  if (picker) {
    ...
    document.getElementById('file-picker-text').textContent = '点击选择 JSON 或 Excel 文件';
  }
...
function onImportFileChange() {
  ...
  if (!file) {
    picker.classList.remove('has-file');
    pickerText.textContent = '点击选择 JSON 或 Excel 文件';
    return;
  }
  picker.classList.add('has-file');
  pickerText.textContent = '已选择：' + file.name;
...
function openPromptSheet() {
  ...
  document.getElementById('prompt-sheet').classList.add('show');
}
function closePromptSheet() {
  document.getElementById('prompt-overlay').classList.remove('show');
  document.getElementById('prompt-sheet').classList.remove('show');
}
function copyPrompt() {
